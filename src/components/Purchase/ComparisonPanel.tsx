...
import { X, BarChart3, ChevronLeft, ChevronRight, Star, Check, ArrowRight } from 'lucide-react';
      ...
      <div className="rounded-r-2xl shadow-2xl overflow-hidden border-r-2" style={{ 
        ...
        {isExpanded && (
          <div className="p-4 animate-slide-down">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-semibold font-poppins truncate" style={{ color: 'var(--color-foreground)' }}>
                          {provider.name}
                        </h4>
                        <button
                          onClick={(e) => {
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <ArrowRight className="h-3 w-3 opacity-0 group-hover:opacity-100 transition-opacity" style={{ color: 'var(--color-primary)' }} />
                      </div>
                      
                      {/* Quick features */}
                      <div className="mt-2 text-xs space-y-1">
                        <div className="flex justify-between">
                          <span style={{ color: 'var(--color-muted)' }}>Hospitals:</span>
                          <span className="font-medium" style={{ color: 'var(--color-foreground)' }}>
                            {provider.features.cashlessHospitals?.toLocaleString()}+
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span style={{ color: 'var(--color-muted)' }}>Claims:</span>
                          <span className="font-medium" style={{ color: 'var(--color-foreground)' }}>
            ...
            {/* Help Text */}
            <p className="text-xs font-roboto text-center mt-3" style={{ color: 'var(--color-muted)' }}>

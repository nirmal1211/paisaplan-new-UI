...
import { 
  ...
  ArrowLeft, Plus, Minus, Info, Award, Clock, TrendingUp, Zap, ChevronDown, ChevronUp
} from 'lucide-react';

const EnhancedProviderDetails: React.FC = () => {
  ...
  const [addOnsSectionExpanded, setAddOnsSectionExpanded] = useState(true);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center space-x-2 mb-2">
                                <h4 className="font-semibold font-poppins text-sm" style={{ color: 'var(--color-foreground)' }}>
                                  {addOn.name}
                                </h4>
                                {addOn.isRecommended && (
                              ...
                              <p className="text-xs font-roboto mb-2" style={{ color: 'var(--color-muted)' }}>
                                {addOn.description}
                              </p>
                              <div className="text-sm font-bold font-poppins" style={{ color: 'var(--color-primary)' }}>
              ...
              {/* Premium Summary and Buy Now - Fixed at Bottom */}
              <div className="rounded-2xl shadow-2xl border-2 overflow-hidden" style={{ 
                backgroundColor: 'var(--color-card)',
                borderColor: 'var(--color-primary)'
              }}>
...
export default EnhancedProviderDetails;
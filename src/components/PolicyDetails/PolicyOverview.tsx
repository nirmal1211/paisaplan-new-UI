            ...
            <div className="p-6 rounded-xl border" style={{ 
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    <div className="flex items-center space-x-1">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`h-4 w-4 ${
                            i < Math.floor(policy.agent.rating)
                    ...
                    <span className="text-sm font-roboto" style={{ color: 'var(--color-muted)' }}>
                      {policy.agent.rating} • {policy.agent.experience}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Phone className="h-4 w-4" style={{ color: 'var(--color-muted)' }} />
                  <a 
              ...
              <div className="flex space-x-3 mt-6">
                ...
                <button 
                  className="flex-1 py-2 px-4 rounded-lg font-medium font-roboto transition-all duration-200"
                  style={{ 

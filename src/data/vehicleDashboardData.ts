  ...
  coverageLimits: [
    {
      ...
      deductible: 5000,
      explanation:
        "Covers damage to your vehicle due to accidents, theft, fire, and natural calamities",
      exclusions: [
    ...
    },
    {
      ...
      deductible: 0,
      explanation:
        "Covers legal liability for injury/death to third parties and damage to third party property",
      exclusions: [

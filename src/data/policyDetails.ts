...
export const mockPolicyDetails: PolicyDetails = {
  ...
  expiryDays: 234,
  description:
    "Comprehensive health insurance plan covering hospitalization, pre and post hospitalization expenses, day care procedures, and annual health checkups.",
  benefits: [
  ...
  dependents: [
    ...
    },
    {
      ...
      age: 5,
      avatar:
        "https://images.pexels.com/photos/1462637/pexels-photo-1462637.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2",
      coverage: "₹10,00,000",
      status: "active",
    },
  ],
  claims: [
    {
      ...
      comments: [
        "Claim approved and settled within 5 days.",
        "All documents were verified successfully.",
      ],
    },
    {
      id: "2",
      ...
      comments: ["Claim is under process. Awaiting final bill from hospital."],
    },
    {
      id: "3",
...
export const mockFAQsDetailed = [
  {
    ...
    answer:
      'You can file a claim online by logging into your account, navigating to the Claims section, and clicking on "File New Claim". Upload the required documents and submit the form. You will receive a claim number for tracking.',
    category: "Claims",
  },
  {
    id: "2",
    ...
    answer:
      "For cashless treatment, visit any network hospital with your health card. The hospital will verify your policy and send a pre-authorization request. Once approved, you can receive treatment without paying upfront.",
    category: "Treatment",
  },
  {
    id: "3",
    ...
    answer:
      "To add a dependent, submit an endorsement request through your online account or contact your agent. Provide the required documents like birth certificate, marriage certificate, etc. Additional premium may apply.",
  ...
  },
  {
    ...
    answer:
      "Pre-hospitalization expenses (30 days before admission) and post-hospitalization expenses (60 days after discharge) related to the same illness are covered. This includes diagnostic tests, medicines, and follow-up consultations.",
    category: "Coverage",
  },
  {
    id: "5",
    ...
    answer:
      "You can renew your policy online through your account, by calling customer service, or through your agent. Renewal should be done before the expiry date to avoid loss of benefits like no-claim bonus.",
    category: "Renewal",
  },
];

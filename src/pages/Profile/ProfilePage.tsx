...
const ProfilePage: React.FC = () => {
  ...
  const updateLoan = (id: string, field: keyof Loan, value: string | number) => {
    setLoans(loans.map(loan => 
      loan.id === id ? { ...loan, [field]: typeof value === 'string' && field !== 'type' ? parseFloat(value) || 0 : value } : loan
    ));
  };
  ...
  const updateInvestment = (id: string, field: keyof Investment, value: string | number) => {
    setInvestments(investments.map(inv => 
      inv.id === id ? { ...inv, [field]: field === 'value' && typeof value === 'string' ? parseFloat(value) || 0 : value } : inv
    ));
  };
  ...
  const updateMedicalCondition = (id: string, field: keyof MedicalCondition, value: string) => {
    setMedicalConditions(medicalConditions.map(cond => 
  ...
  const updateFamilyHistory = (index: number, value: string) => {
    setFamilyHistory(familyHistory.map((item, i) => 
      i === index ? value : item
    ));
  };
    ...
    <div className="min-h-screen py-8" style={{ backgroundColor: 'var(--color-background)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-xl shadow-lg p-6 mb-8" style={{ backgroundColor: 'var(--color-card)' }}>
          ...
          <div className="w-full h-3 rounded-full overflow-hidden" style={{ backgroundColor: 'var(--color-secondary)' }}>
            <div 
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6">
              ...
              <div className="rounded-xl shadow-lg p-6 text-center" style={{ backgroundColor: 'var(--color-card)' }}>
                ...
                <h3 className="text-xl font-bold font-poppins mb-1" style={{ color: 'var(--color-foreground)' }}>
                  {user?.name || "John Doe"}
                </h3>
                <p className="font-roboto" style={{ color: 'var(--color-muted)' }}>
                ...
                <div className="mt-4">
                  ...
                  >
                    {user?.role === 'retail_customer' ? 'Retail Customer' : 'Customer'}
                  </span>
                </div>
              </div>
              ...
              <div className="rounded-xl shadow-lg p-6" style={{ backgroundColor: 'var(--color-card)' }}>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <AlertCircle className="h-5 w-5" style={{ color: 'var(--color-primary)' }} />
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-xl shadow-lg overflow-hidden" style={{ backgroundColor: 'var(--color-card)' }}>
              <div 
                ...
                style={{ 
                  backgroundColor: activeSection === 'personal' ? 'var(--color-secondary)' : 'var(--color-card)',
                  borderBottom: activeSection === 'personal' ? 'none' : `1px solid var(--color-border)`
                }}
              ...
              >
                ...
                {activeSection === 'personal' ? (
                  <ChevronUp className="h-5 w-5" style={{ color: 'var(--color-primary)' }} />
                ) : (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{ 
                          ...
                          backgroundColor: isEditing ? 'var(--color-background)' : 'var(--color-secondary)',
                          color: 'var(--color-foreground)',
            ...
            <div className="rounded-xl shadow-lg overflow-hidden" style={{ backgroundColor: 'var(--color-card)' }}>
              <div 
                className="p-6 flex items-center justify-between cursor-pointer"
                style={{ 
                  backgroundColor: activeSection === 'dependents' ? 'var(--color-secondary)' : 'var(--color-card)',
                  borderBottom: activeSection === 'dependents' ? 'none' : `1px solid var(--color-border)`
                }}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <select
                                ...
                                onChange={(e) => updateDependent(dependent.id, 'gender', e.target.value)}
                                className="w-full px-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                style={{ 
                                  borderColor: 'var(--color-border)',
                                  backgroundColor: 'var(--color-background)',
                            ...
                            <div className="md:col-span-2">
                              ...
                              <input
                                ...
                                onChange={(e) => updateDependent(dependent.id, 'contact', e.target.value)}
                                className="w-full px-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                style={{ 
                                  borderColor: 'var(--color-border)',
                                  backgroundColor: 'var(--color-background)',
            ...
            <div className="rounded-xl shadow-lg overflow-hidden" style={{ backgroundColor: 'var(--color-card)' }}>
              <div 
                className="p-6 flex items-center justify-between cursor-pointer"
                style={{ 
                  backgroundColor: activeSection === 'financial' ? 'var(--color-secondary)' : 'var(--color-card)',
                  borderBottom: activeSection === 'financial' ? 'none' : `1px solid var(--color-border)`
                }}
                ...
                <div className="p-6 border-t" style={{ borderColor: 'var(--color-border)' }}>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2 p-1 rounded-lg" style={{ backgroundColor: 'var(--color-secondary)' }}>
                        <button
                          ...
                          style={{ 
                            backgroundColor: incomeType === 'monthly' ? 'var(--color-primary)' : 'transparent',
                            color: incomeType === 'monthly' ? 'white' : 'var(--color-foreground)'
                          }}
                        >
                          Monthly
                        </button>
                        <button
                          ...
                          style={{ 
                            backgroundColor: incomeType === 'annual' ? 'var(--color-primary)' : 'transparent',
                            color: incomeType === 'annual' ? 'white' : 'var(--color-foreground)'
                          }}
                        >
                          Annual
                        </button>
                        ...
                        {loans.map((loan) => (
                          ...
                          >
                            <div className="flex justify-between items-start mb-3">
                              <h4 className="font-medium font-poppins text-sm" style={{ color: 'var(--color-foreground)' }}>
                                {loan.type || 'New Loan'}
                              </h4>
                              <button
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateInvestment(investment.id, 'value', e.target.value)}
                                    className="w-full pl-7 pr-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                    style={{ 
                                      borderColor: 'var(--color-border)',
                                      backgroundColor: 'var(--color-background)',
            ...
            <div className="rounded-xl shadow-lg overflow-hidden" style={{ backgroundColor: 'var(--color-card)' }}>
              <div 
                className="p-6 flex items-center justify-between cursor-pointer"
                style={{ 
                  backgroundColor: activeSection === 'medical' ? 'var(--color-secondary)' : 'var(--color-card)',
                  borderBottom: activeSection === 'medical' ? 'none' : `1px solid var(--color-border)`
                }}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => updateMedicalCondition(condition.id, 'name', e.target.value)}
                                  className="w-full px-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                  style={{ 
                                    borderColor: 'var(--color-border)',
                                    backgroundColor: 'var(--color-background)',
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => updateMedicalCondition(condition.id, 'since', e.target.value)}
                                  className="w-full px-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                  style={{ 
                                    borderColor: 'var(--color-border)',
                                    backgroundColor: 'var(--color-background)',
                              ...
                              <div className="col-span-2">
                                ...
                                <select
                                  ...
                                  onChange={(e) => updateMedicalCondition(condition.id, 'severity', e.target.value as 'mild' | 'moderate' | 'severe')}
                                  className="w-full px-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                  style={{ 
                                    borderColor: 'var(--color-border)',
                                    backgroundColor: 'var(--color-background)',
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => updateSurgery(surgery.id, 'hospital', e.target.value)}
                                  className="w-full px-3 py-2 border rounded-lg font-roboto text-sm focus:outline-none focus:ring-2 transition-all"
                                  style={{ 
                                    borderColor: 'var(--color-border)',
                                    backgroundColor: 'var(--color-background)',
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-sm font-roboto" style={{ color: 'var(--color-muted)' }}>
                        {lastCheckup ? `${Math.floor((new Date().getTime() - new Date(lastCheckup).getTime()) / (1000 * 60 * 60 * 24 * 30))} months ago` : ''}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="rounded-xl shadow-lg overflow-hidden" style={{ backgroundColor: 'var(--color-card)' }}>
              <div 
                className="p-6 flex items-center justify-between cursor-pointer"
                style={{ 
                  backgroundColor: activeSection === 'notifications' ? 'var(--color-secondary)' : 'var(--color-card)',
                  borderBottom: activeSection === 'notifications' ? 'none' : `1px solid var(--color-border)`
                }}
                ...
                <div className="p-6 border-t" style={{ borderColor: 'var(--color-border)' }}>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg" style={{ backgroundColor: 'var(--color-secondary)' }}>
                      <div>
                        <h3 className="font-medium font-poppins" style={{ color: 'var(--color-foreground)' }}>
                          Login Reminders
                        </h3>
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          ...
                          onChange={() => handleNotificationToggle('loginReminders')}
                        />
                        <div 
                          ...
                          style={{ 
                            backgroundColor: notifications.loginReminders ? 'var(--color-primary)' : undefined,
                            '--tw-ring-color': 'var(--color-primary)',
                        ...
                        >
                          <div 
                            className={`w-5 h-5 rounded-full bg-white transition-transform ${
                              notifications.loginReminders ? 'translate-x-5' : 'translate-x-1'
                            }`}
                            style={{ transform: notifications.loginReminders ? 'translateX(20px)' : 'translateX(2px)', top: '2px', position: 'relative' }}
                          ></div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg" style={{ backgroundColor: 'var(--color-secondary)' }}>
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          ...
                          onChange={() => handleNotificationToggle('policyUploadReminders')}
                        />
                        <div 
                          className={`w-11 h-6 rounded-full peer-focus:ring-2 peer-focus:ring-offset-2 transition-colors ${
                            notifications.policyUploadReminders ? '' : 'bg-gray-300'
                          }`}
                          style={{ 
                            backgroundColor: notifications.policyUploadReminders ? 'var(--color-primary)' : undefined,
                            '--tw-ring-color': 'var(--color-primary)',
                            '--tw-ring-offset-color': 'var(--color-background)'
                          }}
                        >
                          <div 
                            className={`w-5 h-5 rounded-full bg-white transition-transform ${
                              notifications.policyUploadReminders ? 'translate-x-5' : 'translate-x-1'
                            }`}
                            style={{ transform: notifications.policyUploadReminders ? 'translateX(20px)' : 'translateX(2px)', top: '2px', position: 'relative' }}
                          ></div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg" style={{ backgroundColor: 'var(--color-secondary)' }}>
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          ...
                          onChange={() => handleNotificationToggle('policyExpiryAlerts')}
                        />
                        <div 
                          className={`w-11 h-6 rounded-full peer-focus:ring-2 peer-focus:ring-offset-2 transition-colors ${
                            notifications.policyExpiryAlerts ? '' : 'bg-gray-300'
                          }`}
                          style={{ 
                            backgroundColor: notifications.policyExpiryAlerts ? 'var(--color-primary)' : undefined,
                            '--tw-ring-color': 'var(--color-primary)',
                            '--tw-ring-offset-color': 'var(--color-background)'
                          }}
                        >
                          <div 
                            className={`w-5 h-5 rounded-full bg-white transition-transform ${
                              notifications.policyExpiryAlerts ? 'translate-x-5' : 'translate-x-1'
                            }`}
                            style={{ transform: notifications.policyExpiryAlerts ? 'translateX(20px)' : 'translateX(2px)', top: '2px', position: 'relative' }}
                          ></div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg" style={{ backgroundColor: 'var(--color-secondary)' }}>
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          ...
                          onChange={() => handleNotificationToggle('policyExpiredNotifications')}
                        />
                        <div 
                          className={`w-11 h-6 rounded-full peer-focus:ring-2 peer-focus:ring-offset-2 transition-colors ${
                            notifications.policyExpiredNotifications ? '' : 'bg-gray-300'
                          }`}
                          style={{ 
                            backgroundColor: notifications.policyExpiredNotifications ? 'var(--color-primary)' : undefined,
                            '--tw-ring-color': 'var(--color-primary)',
                            '--tw-ring-offset-color': 'var(--color-background)'
                          }}
                        >
                          <div 
                            className={`w-5 h-5 rounded-full bg-white transition-transform ${
                              notifications.policyExpiredNotifications ? 'translate-x-5' : 'translate-x-1'
                            }`}
                            style={{ transform: notifications.policyExpiredNotifications ? 'translateX(20px)' : 'translateX(2px)', top: '2px', position: 'relative' }}
                          ></div>
                        </div>
                      </label>
                    </div>
            ...
            <div className="rounded-xl shadow-lg overflow-hidden" style={{ backgroundColor: 'var(--color-card)' }}>
              <div 
                className="p-6 flex items-center justify-between cursor-pointer"
                style={{ 
                  backgroundColor: activeSection === 'documents' ? 'var(--color-secondary)' : 'var(--color-card)',
                  borderBottom: activeSection === 'documents' ? 'none' : `1px solid var(--color-border)`
                }}
                ...
                <div className="p-6 border-t" style={{ borderColor: 'var(--color-border)' }}>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      <div className="p-4 rounded-full mb-4" style={{ backgroundColor: 'var(--color-secondary)' }}>
                  ...
                  {progress > 0 && progress < 100 && (
                    <div className="mt-4">
                      ...
                      <div className="w-full h-2 rounded-full overflow-hidden" style={{ backgroundColor: 'var(--color-secondary)' }}>
                        <div 
                  ...
                  <div className="mt-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                      <div className="text-center p-3 rounded-lg" style={{ backgroundColor: 'var(--color-secondary)' }}>
                        <div className="font-medium font-poppins mb-1" style={{ color: 'var(--color-foreground)' }}>
                          ID Proof
                        </div>
                        <div className="text-sm font-roboto" style={{ color: 'var(--color-muted)' }}>
                          Aadhar, PAN, Passport
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <button
                                ...
                                className="p-2 rounded-lg hover:opacity-80 transition-colors"
                                style={{ backgroundColor: 'var(--color-card)', color: 'var(--color-danger)' }}
                              >
                                <Trash2 className="h-4 w-4" />
                              </button>
                            </div>

              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {policy.documents.map((doc) => (
                  ...
                  >
                    ...
                    <div className="flex space-x-2">
                      <button
                        className="flex-1 py-2 px-3 rounded-lg font-medium font-roboto text-white transition-all duration-200 hover:opacity-90"
                        style={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {filteredHospitals.map((hospital) => (
                ...
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 mb-3">
                        <div className="flex items-center space-x-1">
                          ...
                          <span
                            className="text-sm font-roboto ml-2"
                            style={{ color: "var(--color-muted)" }}
                          >
                  ...
                  <div className="mb-4">
                    <h4
                      className="font-semibold font-roboto mb-2"
                      style={{ color: "var(--color-foreground)" }}
                    >
                      Specialties:
                    </h4>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <div
                          className="flex items-center space-x-4 text-sm font-roboto"
                          style={{ color: "var(--color-muted)" }}
                        >
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <span
                        ...
                        style={{ color: "var(--color-muted)" }}
                      >
                        {endorsement.documents.length} document
                        {endorsement.documents.length !== 1 ? "s" : ""}
                      </span>
                    </div>
                    <button
                      className="py-2 px-4 rounded-lg font-medium font-roboto text-white transition-all duration-200 hover:opacity-90"
    ...
    <>
      ...
      >
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Support Section */}
          <div
            className="mt-16 rounded-xl shadow-lg p-8 border"
            style={{
              backgroundColor: "var(--color-card)",
              borderColor: "var(--color-border)",
            }}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <h3
                  className="font-semibold font-poppins mb-2"
                  style={{ color: "var(--color-foreground)" }}
                >
                  Email Support
                </h3>
